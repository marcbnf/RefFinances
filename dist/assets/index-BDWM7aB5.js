 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ls{constructor(e,n){this._service=e,n instanceof Lt?this._location=n:this._location=Lt.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new ls(e,n)}get root(){const e=new Lt(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return mE(this._location.path)}get storage(){return this._service}get parent(){const e=qA(this._location.path);if(e===null)return null;const n=new Lt(this._location.bucket,e);return new ls(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw IA(e)}}function hP(t,e,n){return t._throwIfRoot("uploadBytesResumable"),new cP(t,new rr(e),n)}function dP(t){t._throwIfRoot("getDownloadURL");const e=eP(t.storage,t._location,gE());return t.storage.makeRequestWithTokens(e,Br).then(n=>{if(n===null)throw EA();return n})}function fP(t){t._throwIfRoot("deleteObject");const e=tP(t.storage,t._location);return t.storage.makeRequestWithTokens(e,Br)}function pP(t,e){const n=WA(t._location.path,e),r=new Lt(t._location.bucket,n);return new ls(t.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
